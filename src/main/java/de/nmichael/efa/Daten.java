...
public class Daten {
    ...
    public final static String VERSIONID          = "2.2.2_36";   // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta-Version z.B. 1.4.0_#1
    public final static String VERSIONRELEASEDATE = "06.05.2018";  // Release Date: TT.MM.JJJJ
    ...
    public final static String COPYRIGHTYEAR      = "18";   // aktuelles Jahr (Copyright (c) 2001-COPYRIGHTYEAR)
